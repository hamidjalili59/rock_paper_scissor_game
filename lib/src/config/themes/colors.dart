part of 'package:rockie/src/config/themes/app_themes.dart';

const kPrimaryColor = Color(0xff000090);
const kPrimaryDarkColor = Color(0xffFFCC00);
const kSecondaryColor = Color(0xff2DA547);
